...
- `demo_data/`     示範 DB（路徑由 `scripts/seed_demo_dbs` 決定,物理隔離,gitignore）。
...
（見 `multi_agent_system/pipeline/watchlist.load_db_paths`）或 demo → `scripts/seed_demo_dbs` 的 `demo_data/`。
"""
